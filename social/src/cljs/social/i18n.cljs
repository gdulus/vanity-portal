...
(def ^:private messages {"social.welcome.header.1"                              "Dołącz do loży hejterów"
                         ...
                         "social.status.400"                                    "Sprawdź poprawność danych"
                         "social.status.401"                                    "Nazwa konta lub hasło są nie poprawne"
                         "social.status.500"                                    "Wystąpił błąd po stronie serwera - spróbuj jeszcze raz"
                         "social.status.403"                                    "Twoje konto wymaga aktywacji. Sprawdź email :)"
                         "social.status.200"                                    "Dane zostały poprawnie zapisane"
                         ...
                         "vanity.celebrity.celebrityimage.image.null"           "Nie wybrano obrazka do uploadu"
                         "vanity.celebrity.celebrityimage.image.invalid.format" "Nie poprawny format pliku. Dozwolone plik to JPG i PNG"
                         "vanity.celebrity.celebrityimage.image.invalid.size"   "Obrazek zbyt duży (maks. rozmiar 2000px na 2000px)"})
