...
(def ^:private messages {"social.welcome.header.1"                              "Dołącz do loży hejterów"
                         ...
                         "social.status.registeration-details.ok"               "Twoje dane zostały poprawnie zapisane"
                         "social.status.vip-photo-upload.ok"                    "Zdjęcie VIPa zostało uplodowane i oczekuje na moderację"
